                ...
                <div className="flex items-stretch justify-between">
                    ...
                    <div className="flex items-stretch">
                        <div className="hidden sm:flex items-center gap-3 px-3 py-1 text-[var(--text-muted)] text-[10px] border-l border-[var(--border-primary)]/30">
                            {/* Navigation */}
                            <span className="hidden lg:inline"><b className="text-[var(--text-secondary)]">←↓↑→ </b>/<b className="text-[var(--text-secondary)]"> hjkl</b> 导航</span>
                            <span className="hidden lg:inline opacity-30">·</span>
                            {/* Actions */}
                            <span><b className="text-[var(--text-secondary)]">/</b> 搜索</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">空格</b> 切换</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">y</b> 复制</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">d</b> 下载</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">c</b> 清空</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">t</b> 主题</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">Tab</b> 预览</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">Esc</b> 返回</span>
                            <span className="opacity-30">·</span>
                            <span><b className="text-[var(--text-secondary)]">?</b> 帮助</span>
                        </div>
