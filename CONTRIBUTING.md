...
### Setup
```bash
git clone https://github.com/AnYanYi/Linux-app-installer.git
...
Open a [Discussion](https://github.com/AnYanYi/Linux-app-installer/discussions) or create an [Issue](https://github.com/AnYanYi/Linux-app-installer/issues).
